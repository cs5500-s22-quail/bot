...
@Singleton
@Slf4j
public class ShopCommand implements Command, ButtonClickHandler {
    ...
    public void onEvent(CommandInteraction event) {
        ...
        event.reply(getBalanceEB(discordUserId, preferredName).build()).queue();
    }
    ...
    @Nonnull
    private MessageBuilder getBalanceEB(String discordUserId, String preferredName) {
